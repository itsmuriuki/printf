...
```
$ git clone https://github.com/itsmuriuki/printf.git
```
...
## Examples
```
itsmuriuki@ubuntu:~/printf$ cat main.c
#include <limits.h>
#include <stdio.h>
#include "holberton.h"
...
itsmuriuki@ubuntu:~/printf$ gcc -Wall -Wextra -Werror -pedantic -Wno-format *.c
itsmuriuki@ubuntu:~/printf$ ./printf
